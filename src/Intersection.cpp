...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // TrafficLight::getCurrentPhase and TrafficLight::waitForGreen to block the execution until the traffic light turns green.
...
{
    // private member _trafficLight of type TrafficLight. At this position, start the simulation of _trafficLight.
